...
export default function FeaturedCars({ cars, onViewDetails, onAddToCompare }: FeaturedCarsProps) {
              ...
              <CardContent className="p-0">
                <div className="relative overflow-hidden rounded-t-lg">
                  ...
                  <div className="absolute top-3 left-3 space-y-2">
                    {car.condition === 'Mới' && (<Badge className="bg-green-600">Mới</Badge>)}
                  ...
                  <div className="absolute top-3 right-3 space-y-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Button size="sm" variant="secondary" onClick={() => onAddToCompare(car.id)} className="w-10 h-10 p-0">
